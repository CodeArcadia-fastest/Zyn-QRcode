...
document.addEventListener("DOMContentLoaded", function () {
    ...
    generateBtn.addEventListener("click", () => {
        ...
        const qrUrl = `${baseUrl}?size=${qrSize}&data=${encodeURIComponent(content)}&format=${defaultFormat}`;
        ...
        setTimeout(() => {
            document.getElementById("download-btn").addEventListener("click", async () => {
                ...
                const downloadUrl = `${baseUrl}?size=${qrSize}&data=${encodeURIComponent(content)}&format=${format}`;
...
const termsTexts = {
    ru: `
      <p><strong>Важно:</strong> Используя данный сайт, вы соглашаетесь с нижеприведёнными условиями:</p>
      <ul>
    ...
    `,
    en: `
      <p><strong>Important:</strong> By using this site, you agree to the following terms:</p>
      <ul>
